...
<ul class="research-list">
  ...
  <li>
    ...
    <ul class="inner-list">
      ...
      <li><strong>Data collection:</strong> Recruited and tested 60 participants; monitored completion/quality checks for a <a href="https://gorilla.sc/" target="_blank">Gorilla</a>-based online training program.</li>
  ...
  <li>
    ...
    <ul class="inner-list">
      ...
      <li><strong>Design:</strong> Designed eye-tracking experiments in <a href="https://www.sr-research.com/experiment-builder/" target="_blank">SR Research Experiment Builder</a> and developed perception/production stimuli in MATLAB (<a href="https://ieeexplore.ieee.org/document/4518514" target="_blank">TANDEM-STRAIGHT</a>); verified task logic and output formats.</li>
  ...
  <li>
    ...
    <ul class="inner-list">
      ...
      <li><strong>Design:</strong> Synthesized and manipulated stimuli in MATLAB (<a href="https://ieeexplore.ieee.org/document/4518514" target="_blank">TANDEM-STRAIGHT</a>) and implemented the experiment in <a href="https://www.psychopy.org/" target="_blank">PsychoPy</a>; verified task outputs and data logging.</li>
